    ...
    <div className="p-4 mt-9 font-raleway">
      ...
      <div className="flex items-center justify-center mb-6">
        ...
        <div className="flex items-center">
          <div className="relative flex flex-col items-center">
            <div
              className={`w-10 h-10 rounded-full border-8 ${
                currentStep === 1
                  ? "bg-[#528540]  border-[#528540]" // Step 1 (current step)
                  : currentStep > 1
            ...
            <div className="absolute mt-12 text-center">
              <p
                className={`text-sm  ${
                  currentStep === 1 ? "text-gray-400" : "text-gray-400"
                }`}
              >
                Choose a week
              </p>
          ...
          <div
            className={`h-1 ${
              currentStep >= 2 ? "bg-[#528540]" : "bg-[#528540]"
        ...
        <div className="flex items-center">
            ...
            <div
              className={`w-10 h-10 rounded-full border-8 ${
                currentStep === 2
                  ...
                  : "bg-[#528540] border-[#528540]" // Step 2 (not started)
              }`}
            ></div>
            <div className="absolute mt-12 text-center">
              <p
          ...
          <div
            className={`h-1 ${
              currentStep >= 3 ? "bg-[#528540]" : "bg-[#528540]"
            }  w-24 sm:w-48 md:w-56 lg:w-56 xl:w-64`}
          ></div>
        </div>
            ...
            <div
              className={`w-10 h-10 rounded-full border-8 ${
                currentStep === 3
                  ...
                  : "bg-[#fffbf1] border-[#528540]" // Step 3 (not started)
              }`}
            ></div>
...
export default ProgressBarDishSelect;
